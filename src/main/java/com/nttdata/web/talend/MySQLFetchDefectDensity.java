...
/**
 * Job: Redmine_JOB_To_Fetch_Data_Context Purpose:
 * Redmine_JOB_To_Fetch_Data_Context<br>
 * Description: Redmine_JOB_To_Fetch_Data_Context <br>
 * 
 * @author user@talend.com
 * @version 6.2.0.20160510_1709
 * @status
 */
public class MySQLFetchDefectDensity implements TalendJob {
...
/*	public class ContextProperties extends java.util.Properties {
	...
	private final String jobName = "Redmine_JOB_To_Fetch_Data_Context";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					MySQLFetchDefectDensity.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(MySQLFetchDefectDensity.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_WORKSPACE_CRESTA_Redmine_JOB_To_Fetch_Data_Context = new byte[0];
		static byte[] commonByteArray_WORKSPACE_CRESTA_Redmine_JOB_To_Fetch_Data_Context = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_WORKSPACE_CRESTA_Redmine_JOB_To_Fetch_Data_Context) {
				try {
					int length = 0;
					this.RELEASE_VERSION = readInteger(dis);
					this.DENSITY = readInteger(dis);
				} catch (IOException e) {
	...
	public void tMysqlInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(context.getProperty("output_folder")+ context.getProperty("output_file_name")+ ".csv"))
				...
				if (filetFileOutputDelimited_1.length() == 0) {
					...
					outtFileOutputDelimited_1.write("DENSITY");
				...
				String [] qryArgs = context.getProperty("query_args").split(",");
				Map qryArgsMap = (Map) context.get("query_args_map");
				java.sql.PreparedStatement stmt_tMysqlInput_1 = conn_tMysqlInput_1.prepareStatement(dbquery_tMysqlInput_1);
//				java.sql.ResultSetMetaData rsmd_tMysqlInput_1 = null;
				...
				java.sql.ResultSet rs_tMysqlInput_1 =(ResultSet) jdbcTemplate.execute(dbquery_tMysqlInput_1, qryArgsMap, new PreparedStatementCallback() {
					
					@Override
					public ResultSet doInPreparedStatement(PreparedStatement ps) throws SQLException, DataAccessException {
						//rsmd_tMysqlInput_1 = rs_tMysqlInput_1.getMetaData();
						return ps.executeQuery();
					}

				});
				
				SqlRowSet rs = jdbcTemplate.queryForRowSet(dbquery_tMysqlInput_1, qryArgsMap);
				

				/*int i=1;
				for(String str : qryArgs){
					stmt_tMysqlInput_1.setString(i, str);
					i++;
				}*/
				...
				try {
					//rs_tMysqlInput_1 = stmt_tMysqlInput_1.executeQuery();
					 SqlRowSetMetaData rsmd_tMysqlInput_1 = rs.getMetaData();
					...
					while (rs.next()) {
						...
						if (colQtyInRs_tMysqlInput_1 < 1) {
							...
							if (rs.getObject(1) != null) {
								row1.RELEASE_VERSION = rs.getInt(1);
							} else {
								row1.RELEASE_VERSION = null;
							}
						}
						...
						if (row1.DENSITY != null) {
							sb_tFileOutputDelimited_1.append(row1.DENSITY);
						}
	...
	public static void main(String[] args) {
		final MySQLFetchDefectDensity Redmine_JOB_To_Fetch_Data_ContextClass = new MySQLFetchDefectDensity();

		int exitCode = Redmine_JOB_To_Fetch_Data_ContextClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Redmine_JOB_To_Fetch_Data_Context");
		}
...
/************************************************************************************************
 * 37773 characters generated by Talend Open Studio for Data Integration on the
 * September 27, 2016 6:30:40 PM IST
 ************************************************************************************************/
