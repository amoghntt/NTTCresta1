...
cols = ['defect_count','KLOC', 'test_case_count', 'application_complexity', 'domain_knowledge', 'technical_skills', 'requirements_query_count', 'code_review_comments', 'design_review_comments','effort_to_fix_defect', 'cost_to_fix_defect','impact_of_defect_fix', 'feasibility_within_milestone', 'availability_of_budget', 'complexity_of_defect_fix', 'bg_severity', 'bg_priority','defect_count/KLOC']
