...
function validateForm(){
		 ...
		 var z = document.getElementById('lcl').value;
...
<div id="defects" class="tabcontent">
	<table align="center" style="font-family: Verdana;font-weight: bold;color=color:#FF8C00">
<tr>
<td> Project
</td>
<td>
...
<form:form method="POST" action="predictDefectDensity">
		...
		<td align="center"><div id="weightage">Weightage</div></td>
				...
				<c:forEach items="${configBean.predictBean.metricsList}" var="metrics" varStatus="counter">
					<tr> 
						...
						<td>
								<input  class="textb"  type="text" id="lclId${counter.count-1}0" name="predictBean.metricsList[${counter.count  - 1}].lcl[0]" value="<c:out value="${metrics.lcl[0]}"/>" onkeypress="return isNumber(event)"> &nbsp;
...
<div id="loading">
  <img id="loading-image" src="<%=request.getContextPath()%>/resources/images/ajax-loader.gif" alt="Loading..." />
</div>
