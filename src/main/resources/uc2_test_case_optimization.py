...
with open('/opt/apache-tomcat-8.0.36/webapps/resources1/textrequirementprocessed.txt', 'r') as myfile:
...
for sentence in content:
    ...
    for sentence1 in content:
        ...
        if (sentence is not sentence1):
            with open('/opt/apache-tomcat-8.0.36/webapps/resources1/result.txt', 'w') as myfile:
                myfile.write(sentence + "\n")
                myfile.write(sentence1)
            inputData1 = gensim.models.word2vec.LineSentence("/opt/apache-tomcat-8.0.36/webapps/resources1/result.txt")
